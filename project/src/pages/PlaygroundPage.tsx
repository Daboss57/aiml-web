...
const PlaygroundPage: React.FC = () => {
  ...
  const handleRunCode = async () => {
    ...
    try {
      ...
      // Simple simulation of code execution based on language
      switch (activeLanguage) {
        case 'javascript':
          try {
            // Create a sandbox function to evaluate the code with console.log redirected
            const logs: string[] = [];
            ...
            // Use Function constructor to evaluate the code (this is simplified and not secure)
            new Function(code)();
            ...
            throw new Error(`JavaScript error: ${(e as Error).message}`);
          }
          break;
          
        case 'python':
          setOutput('Python code execution is simulated:\n\nHello, World!');
          break;
          
        case 'html':
          setOutput('HTML preview would be shown in a separate panel in a real application.');
          break;
          
        default:
          setOutput('Code executed (simulated)');
      }
    } catch (error) {
